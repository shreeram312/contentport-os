      ...
      >
        ...
        <div
          className={cn(
            ...
            side === "left"
              ? "left-0 w-[--sidebar-width] group-data-[collapsible=offcanvas]:-translate-x-full"
              : "right-0 w-[--right-sidebar-width] group-data-[collapsible=offcanvas]:translate-x-full",
            variant === "floating" || variant === "inset"
